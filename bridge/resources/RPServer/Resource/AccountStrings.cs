namespace RPServer.Resource
{
    public static class AccountStrings
    {
        ...
        public const string ErrorChangeVerificationEmailDuplicate = "The new email address must be different than the old one.";
        ...
        public const string ErrorInvalidCredentials = "You have provided invalid an invalid username/password combination.";
        ...
        public const string SuccessResendVerificationEmail = "We have re-sent an email containing your verification token to your inbox.";
        public const string VerifyTwoFactorByGA = "Please verify using the Google Authenticator App.";
        public const string TwoFactorByEmailIsNotEnabled = "Two Factor Authentication by Email is not enabled for this account.";
    }
}
